...
class YouTubeExtractor:
        ...
        self._base_opts: Dict[str, Any] = {
            ...
            "extractor_args": {
                "youtube": {
                    ...
                    # Use maintained clients and let yt-dlp's JS challenge
                    # solver handle the web request when cookies are present.
    ...
    def _pick_audio_source(self, info: Dict[str, Any]) -> tuple[Optional[str], Dict[str, str]]:
        """Return the resolved URL and headers required to open it with FFmpeg."""
